...
def inference(global_config,
    ...
    for p in glob.glob(input_paths):
        ...
        if pc_full is None:
            logger.info('Converting depth to point cloud(s)...')
...
if __name__ == "__main__":
    ...
    global_config = config_utils.load_config(FLAGS.ckpt_dir,
